...
namespace Chessboard
{
    internal class View
    {
        public static void Help()
        {
            ...
            Console.WriteLine($"The width of the chessboard should range from {Chessboard.minSide} to {Console.WindowWidth}.");
            Console.WriteLine($"The height of the chessboard should range from {Chessboard.minSide} to {Console.WindowHeight}.");
        }
        public static void Task()
        {
            ...
            var chessboard = new Chessboard(12, 4);
